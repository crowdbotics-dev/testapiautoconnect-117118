...
## Project Structure
    ...
    ├── testapiautoconnect_117118  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_117118`
...
2. Clone this repo and `cd testapiautoconnect_117118`
